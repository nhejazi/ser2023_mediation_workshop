...
```{r, engine="tikz", fig.cap = "Parallel worlds model of the scenario considered.", fig.ext=if (knitr:::is_latex_output()) "pdf" else "png", echo = FALSE}
\dimendef\prevdepth=0
\pgfdeclarelayer{background}
\pgfsetlayers{background,main}
\usetikzlibrary{arrows,positioning}
...
```{r , echo=FALSE, fig.cap="Excerpted from @rudolph2019causal", fig.ext=if (knitr:::is_latex_output()) "pdf" else "png", out.width = "125%", results="asis"}
